...
public class StoryRatingPK implements Serializable{

	private Long storyId;
	private Long voterId; 	
	
	public StoryRatingPK(){}
	
	public StoryRatingPK(Long storyId, Long voterId) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		StoryRatingPK other = (StoryRatingPK) obj;
		if (storyId == null) {
